...
{
    const status = (0, _openDateJs.isBDay)();
    if (status === "IS_EARLY") (0, _setPageJsDefault.default)((0, _pagesJs.soon));
    if (status === "IS_LATE") (0, _setPageJsDefault.default)((0, _pagesJs.late));
    if (status === "ON_TIME") (0, _animationJs.animate)();
}
...
const isBDay = function() {
    const startTime = new Date("2022-08-09T00:00").getTime();
...
const frames = document.querySelectorAll(".frame"), msgWindow = document.querySelector(".scroll"), msg = document.querySelector(".text"); // the Message para
//Sfx files
    ...
    button.addEventListener("click", function() {
        if (button.classList.contains("switch")) {
          ...
          */ haunt.pause();
            ...
            const readTime = parseInt(getComputedStyle(document.documentElement).getPropertyValue("--readTime")) + 5;
